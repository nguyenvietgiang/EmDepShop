<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="EmDepSite.index" %>
            ...
            <div id="trangtrai">
                   ...
                   <div id="pichotro">
                    ...
                    <div class="support">
                        <div class="text-center">
                            <p>
                                <span class="supp-name">Việt Giang</span>
                                <br />                    
                                <span class="phone">090.2234.481</span>
                            </p>  
                            <a href="https://www.facebook.com/profile.php?id=100026626365271" class="Facebook">
                                     <img src="css/images/Facebook_Logo%20(1).png" />               
                            </a>
                            <a href="https://www.instagram.com/giangnguyen2355/" class="Instagram">
                                <img src="css/images/logo-instagram-5%20(1).jpg" />
                            </a>                          
                        </div>
                        <div class="text-center">
                            <p>
                        ...
                        <div class="text-center">
                            <p>
                                ...
                                <br />
                                <span class="phone">7h30 Sáng đến 10h30 Tối</span>
                            </p>
                        </div>
                    </div>              
                </div>
                ...
                <div id="thongketruycap">
                    ...
                    <div class="so-thongke">
                        <p id="ltc" runat ="server"></p>                      
                        <p>Tổng lượt truy cập: 1059</p>
                    </div>
                </div>
            </div>
                ...
                <div class="sanpham">
                    <div id="sanphamnoibat">
                        <div class="title-line">
                            <h3>SẢN PHẨM CẦN TÌM: <asp:Label ID="Label1" runat="server" Text="Label"></asp:Label> </h3>
                        </div>
                    ...
                    <div id="sanphamnoibat">
                        ...
                        <asp:ListView ID="ListView1" runat="server">
                            <ItemTemplate>     
                                ...
                                <div class="desc">
                                   <p id="gia2">Giá: <%# Eval("iGia") %> Đồng</p>
                                </div>
                                         </a>
                            </div>
                     ...
                     <div id="sanphamnoibat">
                        ...
                        <asp:ListView ID="ListView2" runat="server">
                            <ItemTemplate>
                                ...
                                <div class="desc">
                                   <p id="gia3">Giá: <%# Eval("iGia") %> Đồng</p>
                                </div>
                                         </a>
                            </div>
